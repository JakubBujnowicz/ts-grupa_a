...
Widzimy, że nasze dane cechują się silną sezonowością (okres 12 miesięcy) oraz 
posiadają zmienny trend. Od około 2014 możemy zaobserwować tendencję spadkową.
...
Najmniejsze błędy w predykcji okazał się generować model autoregresyjny, przy
czym model MA poradził sobie tylko niewiele gorzej.
ARIMA z automatycznie dobranymi parametrami spowodowała dużo większe błędy.
Transformację Boxa-Coxa również znacznie pogorszyła skuteczność prognozy.
